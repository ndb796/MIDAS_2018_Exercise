...
public class MainActivity_User extends AppCompatActivity {
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void init() {
        Log.d("MainActivity_User", "init - execute");
        ...
        sectionsPagerAdapter = new SectionsPagerAdapter_Client(getSupportFragmentManager());
    ...
    private void initActionbar() {
        Log.d("MainActivity_User", "initActionbar - execute");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        Log.d("MainActivity_User", "onCreateOptionsMenu - execute");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Log.d("MainActivity_User", "onOptionsItemSelected - execute");
    ...
    private void ShowDetailContents(ContentsData data) {
        Log.d("MainActivity_User", "ShowDetailContents - execute");
    ...
    class MessageHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            Log.d("MainActivity_User", "handleMessage - " + msg.what);
